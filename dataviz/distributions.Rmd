...
Uma observação final: como os FDCs podem ser matematicamente definidos, a palavra _empírico_ é adicionada para distinguir quando os dados são usados. Portanto, usamos o termo FDC empírico (FDCE).


## Histogramas

Embora o conceito de FDC seja amplamente discutido nos livros estatísticos, o gráfico não é muito popular na prática. O principal motivo é que ele não transmite facilmente características de interesse, como: Em que valor a distribuição se concentra? A distribuição é simétrica? Quais intervalos contêm 95% dos valores? Os histogramas são preferidos porque facilitam muito a resposta a essas perguntas. Os histogramas sacrificam apenas um pouco de informação para produzir gráficos muito mais fáceis de interpretar.
...
3\. O gráfico a seguir mostra o FDCE para a altura dos homens:
...
5\. Aqui está um FDCE das taxas de homicídio entre os estados:
...
6\. De acordo com o FDCE anterior, qual das seguintes afirmações é verdadeira?
