...
o que significa que aproximadamente `r noquote(paste0(round(mean(dplyr::between(heights$height[heights$sexo == "Male"], 65, 68)), 2) * 100, '%'))`das alturas dos machos estão entre 65 e 68 polegadas.
