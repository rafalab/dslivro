...
Para gerar um gráfico de barras (_barplots_ em inglês), podemos usar a geometria `geom_bar`. Por padrão, R conta os casos em cada categoria e desenha uma barra. Aqui vemos o gráfico de barras para as regiões dos Estados Unidos.
