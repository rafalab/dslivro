...
O desvio padrão (do inglês _standard deviation_ ou SD), de uma lista `x` (usamos as alturas abaixo como exemplo) é definida como a raiz quadrada da média das diferenças quadradas:
