...
Variáveis aleatórias são os resultados numéricos de processos aleatórios. Podemos facilmente gerar variáveis aleatórias usando alguns dos simples exemplos que mostramos anteriormente. Por exemplo, vamos definir `X` igual a 1 se uma miçanga (_bead_ em inglês) for azul ou igual a 0 caso seja vermelha:
...
Aqui `X` é uma variável aleatória: toda vez que selecionamos uma nova miçanga, o resultado muda aleatoriamente. Veja abaixo:
