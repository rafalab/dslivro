...
O Teorema do Limite Central funciona quando o número de sorteios é amplo. Mas amplo é um termo relativo. Em muitas circunstâncias, apenas 30 sorteios são suficientes para que o TLC seja útil. Em alguns casos específicos, apenas 10 sorteios são suficientes. No entanto, essas não devem ser consideradas regras gerais. Por exemplo, quando a probabilidade de sucesso é muito pequena, precisamos de tamanhos de amostra muito maiores.
